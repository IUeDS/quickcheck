...
//this file has alterations from MM. added in instructions for end-user and some CSS tweaks.
 tinymce.PluginManager.add('mathquill', function (editor, url) {

     var pluginHtml = "<div class=\"qc-math-editor\" style=\"all:initial;\">" +
            "<style type=\"text/css\">.mq-root-block * {vertical-align:middle;text-align:center;}" +
            ".qc-math-editor a:hover { cursor: pointer; } .qc-math-editor a { text-decoration: underline; }</style>" +
            "<link rel=\"stylesheet\" href=\"" + url + "/vendor/mathquill.css\" /> " +
            "<p style=\"padding: 5px;\">Type LaTeX and it will format itself as you type. " +
            "<a href=\"https://en.wikipedia.org/wiki/Wikipedia:LaTeX_symbols\" target=\"_blank\">Find LaTeX symbols.</a></p>" +
            "<span id=\"math-field" + editor.id + "\" style=\"position:absolute;left:5px;right:5px;top:5px;bottom:5px;margin-top:20px;\"></span></div>",
         panelButton = {
         type: 'panelbutton',
         panel: {
             role: 'application',
             ...
             onpostRender: function (e) {
                 ...
                 //MM: allow LaTeX symbol link to open in new tab; tinymce blocks links by default
                 //https://stackoverflow.com/questions/34167217/preserve-hyperlink-navigation-in-inline-tinymce
                 $('.qc-math-editor a').on('click', function() {
