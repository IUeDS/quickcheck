...
describe('Viewing analytics for an assessment', function() {
    ...
    it('should show buttons for downloading responses CSV and attempts CSV', function() {
        attemptsPage.viewAnalytics();
        expect(analytics.getResponsesCsvBtn().isDisplayed()).toBe(true);
        expect(analytics.getAttemptsCsvBtn().isDisplayed()).toBe(true);
    });

    it('should show the correct number of total attempts', function() {
        expect(analytics.getTotalAttempts()).toContain('4');
    });

    it('should show the correct number of attempts per student', function() {
        expect(analytics.getAvgAttempts()).toContain('2');
    });

    it('should show the correct median score', function() {
        expect(analytics.getMedianScore()).toContain('50%');
    });

    it('should show the average time spent', function() {
        //we can't know the exact time for sure, but we know it's less than a minute
        expect(analytics.getAvgTime()).toContain('seconds');
    });

    it('should show the correct percentage of students who got a question right', function() {
        expect(analytics.getQuestionPercentCorrect(0)).toContain('50%');
    });

    it('should show the question text for a question', function() {
        expect(analytics.getQuestionText(0)).toContain(quizData.question1.questionText);
    });
    ...
    describe('for a multiple choice question', function() {
        ...
        it('should show the options correctly', function() {
            optionItems.forEach(function(optionItem, index) {
                expect(options.get(index).getText()).toBe(optionItem);
            });
        });

        it('should show the percentages correctly', function() {
            ...
            expect(percentages.get(1).getText()).toContain('50%');
        });
    });
    ...
    describe('for a multiple correct question', function() {
        ...
        it('should show the percentages correctly', function() {
            percentageItems.forEach(function(percentageItem, index) {
                expect(percentages.get(index).getText()).toContain(percentageItem);
            });
        });
    });
    ...
    describe('for a matrix question', function() {
        ...
        it('should have the correct row options', function() {
            rowItems.forEach(function(rowItem, index) {
                expect(rows.get(index).getText()).toContain(rowItem);
            });
        });

        it('should have the correct column options', function() {
            columnItems.forEach(function(columnItem, index) {
                expect(columns.get(index).getText()).toContain(columnItem);
            });
        });

        it('should have the correct percentages', function() {
            var i = 0;

            percentages.each(function(percentage) {
                expect(percentage.getText()).toContain('50%');
            });
        });
    });
    ...
    describe('for a matching question', function() {
        ...
        it('should have the correct prompts', function() {
            promptItems.forEach(function(promptItem, index) {
                expect(prompts.get(index).getText()).toContain(promptItem);
            });
        });

        it('should have the correct answers', function() {
            answerItems.forEach(function(answerItem, index) {
                expect(answers.get(index).getText()).toContain(answerItem);
            });
        });
    ...
    describe('for a textmatch question', function() {
        ...
        it('should have the correct answers', function() {
            expect(answers.get(0).getText()).toContain(questionData.option1);
        });

        it('should have the correct percentages', function() {
            expect(percentages.get(0).getText()).toContain('50%');
        });

        it('should show other responses', function() {
            var responses;

            analytics.toggleOtherResponses(5);
            ...
            responses.count().then(function(responseCount) {
                if (responseCount === 0) {
                    analytics.toggleOtherResponses(5);
                    responses = analytics.getOtherResponses();
                }
                expect(responses.count()).toBe(1);
                expect(responses.get(0).getText()).toBe('Totally the wrong answer');
                analytics.toggleOtherResponses(5); //close
            });
        });
    });
    ...
    describe('for a numerical question', function() {
        ...
        it('should show other responses', function() {
            ...
            analytics.toggleOtherResponses(6);
            responses = analytics.getOtherResponses();
            expect(responses.count()).toBe(1);
            expect(responses.get(0).getText()).toBe('10000000.000000');
            analytics.goBack();
            attemptsPage.goBack();
        });
    });
